...
public class DetailDocument_Acti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id!=-1 && !type.equals("")){
            ...
            detailDoc_viewModel.getDetailDocLiveData().observe(this, new Observer<News_Detail>() {
                @Override
    ...
    public void showTinLienQuan(News_Detail doc){
        ...
        DetailNew_RelatedNews_Adapter adapter = new DetailNew_RelatedNews_Adapter(DetailDocument_Acti.this, doc.getNews());
    ...
    public void dowloadVanBan(News_Detail doc){
        ...
        Toast.makeText(DetailDocument_Acti.this, "Đang tải ảnh về.....", Toast.LENGTH_SHORT).show();
    }
