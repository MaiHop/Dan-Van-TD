...
public class DetailNew_Acti extends AppCompatActivity {
...
//            Log.d("IMG_SRC: ", i+" "+arr_img[i]+"\n");
        ...
        if (!list_Image.isEmpty()){
            ...
            DetailNew_Image_Adapter adapter = new DetailNew_Image_Adapter(DetailNew_Acti.this, list_Image);
    ...
    public void showTinLienQuan(News_Detail d){
        ...
        DetailNew_RelatedNews_Adapter adapter = new DetailNew_RelatedNews_Adapter(DetailNew_Acti.this, d.getNews());
